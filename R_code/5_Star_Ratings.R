...
## 2008
ma.path.2008a <- paste0(path.data.ma,"/ma-star-ratings/2008/2008_Part_C_Report_Card_Master_Table_2009_11_30_stars.csv")
star.data.2008a <- read_csv(ma.path.2008a,
                         skip=4,
                         col_names=rating.vars.2008)

ma.path.2008b <- paste0(path.data.ma,"/ma-star-ratings/2008/2008_Part_C_Report_Card_Master_Table_2009_11_30_domain.csv")
...
## 2009
ma.path.2009a <- paste0(path.data.ma,"/ma-star-ratings/2009/2009_Part_C_Report_Card_Master_Table_2009_11_30_stars.csv")
...
ma.path.2009b <- paste0(path.data.ma,"/ma-star-ratings/2009/2009_Part_C_Report_Card_Master_Table_2009_11_30_summary.csv")
...
## 2010
ma.path.2010a <- paste0(path.data.ma,"/ma-star-ratings/2010/2010_Part_C_Report_Card_Master_Table_2009_11_30_domain.csv")
...
ma.path.2010b <- paste0(path.data.ma,"/ma-star-ratings/2010/2010_Part_C_Report_Card_Master_Table_2009_11_30_summary.csv")
...
## 2011
ma.path.2011a <- paste0(path.data.ma,"/ma-star-ratings/2011/2011_Part_C_Report_Card_Master_Table_2011_04_20_star.csv")
...
ma.path.2011b <- paste0(path.data.ma,"/ma-star-ratings/2011/2011_Part_C_Report_Card_Master_Table_2011_04_20_summary.csv")
...
## 2012
ma.path.2012a <- paste0(path.data.ma,"/ma-star-ratings/Part C 2012 Fall/2012_Part_C_Report_Card_Master_Table_2011_11_01_Star.csv")
...
ma.path.2012b <- paste0(path.data.ma,"/ma-star-ratings/Part C 2012 Fall/2012_Part_C_Report_Card_Master_Table_2011_11_01_Summary.csv")
...
## 2013
ma.path.2013a <- paste0(path.data.ma,"/ma-star-ratings/Part C 2013 Fall/2013_Part_C_Report_Card_Master_Table_2012_10_17_Star.csv")
...
ma.path.2013b <- paste0(path.data.ma,"/ma-star-ratings/Part C 2013 Fall/2013_Part_C_Report_Card_Master_Table_2012_10_17_Summary.csv")
...
## 2014
ma.path.2014a <- paste0(path.data.ma,"/ma-star-ratings/Part C 2014 Fall/2014_Part_C_Report_Card_Master_Table_2013_10_17_stars.csv")
...
ma.path.2014b <- paste0(path.data.ma,"/ma-star-ratings/Part C 2014 Fall/2014_Part_C_Report_Card_Master_Table_2013_10_17_summary.csv")
...
## 2015
ma.path.2015a <- paste0(path.data.ma,"/ma-star-ratings/2015 Fall/2015_Report_Card_Master_Table_2014_10_03_stars.csv")
...
ma.path.2015b <- paste0(path.data.ma,"/ma-star-ratings/2015 Fall/2015_Report_Card_Master_Table_2014_10_03_summary.csv")
