...
macd.path.2007=paste0(path.data.ma,"/ma-plan-characteristics/PartCD/2007/Medicare Part D 2007 Plan Report 12-06-06.xls")
...
## Raw 2008 data
ma.path.2008a=paste0(path.data.ma,"/ma-plan-characteristics/2008LandscapeSourceData_MA_09_25_07(A-M).csv")
...
ma.path.2008b=paste0(path.data.ma,"/ma-plan-characteristics/2008LandscapeSourceData_MA_09_25_07(N-W).csv")
...
macd.path.2008a=paste0(path.data.ma,"/ma-plan-characteristics/PartCD/2008/Medicare Part D 2008 Plan Report 11-06-07.xls")
...
macd.path.2008b=paste0(path.data.ma,"/ma-plan-characteristics/PartCD/2008/Medicare Part D 2008 Plan Report 11-06-07.xls")
...
## Raw 2009 data
ma.path.2009a=paste0(path.data.ma,"/ma-plan-characteristics/2009LandscapeSourceData_MA_11_05_08_A_to_M.csv")
...
ma.path.2009b=paste0(path.data.ma,"/ma-plan-characteristics/2009LandscapeSourceData_MA_11_05_08_N_to_W.csv")
...
macd.path.2009a=paste0(path.data.ma,"/ma-plan-characteristics/PartCD/2009/Medicare Part D 2009 Plan Report 11-03-08.xls")
...
macd.path.2009b=paste0(path.data.ma,"/ma-plan-characteristics/PartCD/2009/Medicare Part D 2009 Plan Report 11-03-08.xls")
...
## Raw 2010 data
ma.path.2010a=paste0(path.data.ma,"/ma-plan-characteristics/2010LandscapeSourceData_MA_12_01_09_A_to_M.csv")
...
ma.path.2010b=paste0(path.data.ma,"/ma-plan-characteristics/2010LandscapeSourceData_MA_12_01_09_N_to_W.csv")
...
macd.path.2010a=paste0(path.data.ma,"/ma-plan-characteristics/PartCD/2010/Medicare Part D 2010 Plan Report 09-14-09.xls")
...
macd.path.2010b=paste0(path.data.ma,"/ma-plan-characteristics/PartCD/2010/Medicare Part D 2010 Plan Report 09-14-09.xls")
...
## Raw 2011 data
ma.path.2011a=paste0(path.data.ma,"/ma-plan-characteristics/2011LandscapeSourceData_MA_12_17_10_AtoM.csv")
...
ma.path.2011b=paste0(path.data.ma,"/ma-plan-characteristics/2011LandscapeSourceData_MA_12_17_10_NtoW.csv")
...
macd.path.2011a=paste0(path.data.ma,"/ma-plan-characteristics/PartCD/2011/Medicare Part D 2011 Plan Report 09-15-10.xls")
...
macd.path.2011b=paste0(path.data.ma,"/ma-plan-characteristics/PartCD/2011/Medicare Part D 2011 Plan Report 09-15-10.xls")
...
## Raw 2012 data
ma.path.2012a=paste0(path.data.ma,"/ma-plan-characteristics/2012LandscapeSourceData_MA_3_08_12_AtoM.csv")
...
ma.path.2012b=paste0(path.data.ma,"/ma-plan-characteristics/2012LandscapeSourceData_MA_3_08_12_NtoW.csv")
...
macd.path.2012a=paste0(path.data.ma,"/ma-plan-characteristics/PartCD/2012/Medicare Part D 2012 Plan Report 09-08-11.xls")
...
macd.path.2012b=paste0(path.data.ma,"/ma-plan-characteristics/PartCD/2012/Medicare Part D 2012 Plan Report 09-08-11.xls")
...
## Raw 2013 data
ma.path.2013a=paste0(path.data.ma,"/ma-plan-characteristics/2013LandscapeSource file MA_AtoM 11212012.csv")
...
ma.path.2013b=paste0(path.data.ma,"/ma-plan-characteristics/2013LandscapeSource file MA_NtoW 11212012.csv")
...
macd.path.2013a=paste0(path.data.ma,"/ma-plan-characteristics/PartCD/2013/Medicare Part D 2013 Plan Report 04252013v1.xls")
...
macd.path.2013b=paste0(path.data.ma,"/ma-plan-characteristics/PartCD/2013/Medicare Part D 2013 Plan Report 04252013v1.xls")
...
## Raw 2014 data
ma.path.2014a=paste0(path.data.ma,"/ma-plan-characteristics/2014LandscapeSource file MA_AtoM 05292014.csv")
...
ma.path.2014b=paste0(path.data.ma,"/ma-plan-characteristics/2014LandscapeSource file MA_NtoW 05292014.csv")
...
macd.path.2014a=paste0(path.data.ma,"/ma-plan-characteristics/PartCD/2014/Medicare Part D 2014 Plan Report 05292014.xls")
...
macd.path.2014b=paste0(path.data.ma,"/ma-plan-characteristics/PartCD/2014/Medicare Part D 2014 Plan Report 05292014.xls")
...
## Raw 2015 data
ma.path.2015a=paste0(path.data.ma,"/ma-plan-characteristics/2015LandscapeSource file MA_AtoM 11042014.csv")
...
ma.path.2015b=paste0(path.data.ma,"/ma-plan-characteristics/2015LandscapeSource file MA_NtoW 11042014.csv")
...
macd.path.2015a=paste0(path.data.ma,"/ma-plan-characteristics/PartCD/2015/Medicare Part D 2015 Plan Report 03182015.xls")
