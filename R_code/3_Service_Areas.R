...
write_tsv(contract.service.area,path=paste(here("/Contract_Service_Area.txt"),sep=""),append=FALSE,col_names=TRUE)
write_rds(contract.service.area,paste(here("/contract_service_area.rds"),sep=""))
